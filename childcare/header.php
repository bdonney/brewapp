...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Childcare Organization</title>
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="index.php?action=product/all">electronics</a></li>
                  <li><a href="index.php?action=product/create">crafts</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Students <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="index.php?action=camper/all">Infants</a></li>
                  <li><a href="index.php?action=camper/create">Toddlers</a></li>
                       </ul>
              </li>
              <li><button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Send a Note</button></li>
            </ul>
			<ul class="pull-right nav"><li><a href="index.php?action=recipe/create">Login</a></li>
