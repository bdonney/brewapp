		...
		<div class="learn-more">
			<div class="container">
				<div class="row">
					<div class="col-lg-4">
						<h3>Learn More</h3>
						<p>Want to know more about what we provide? Want examples? Want to see what we can do for you?</p>
						<p><a href="#">Click Here</a>
					</div>
					
					<div class="col-lg-4">
						<h3>Find a beer</h3>
						<p>Need help choosing a beer? We can help you choose.</p>
						<p><a href="#">Find one now</a>
					</div>
